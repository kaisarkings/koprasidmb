...
with open('src/utils/themeUtils.ts', 'r') as f:
    content = f.read()

# Let's completely rewrite themeUtils to respect dark mode better for neo brutalism and standard mode
new_content = """export const getCardClass = (uiStyle: string) => {
...
with open('src/utils/themeUtils.ts', 'w') as f:
    f.write(new_content)
